...
#mod for bayesian nn
def create_dropout_encoder(input_height=224 ,  input_width=224 , pretrained='imagenet',dropout_rate = 0):
	assert input_height%32 == 0
	assert input_width%32 == 0
	...
	x = ( BatchNormalization())(x)
	x = MaxPooling2D((2, 2), strides=(2, 2), name='block3_pool', data_format=IMAGE_ORDERING )(x)
	x = Dropout(dropout_rate,name="block3_dropout")(x, training=True)
	f3 = x
	...
	x = ( BatchNormalization())(x)
	x = MaxPooling2D((2, 2), strides=(2, 2), name='block4_pool', data_format=IMAGE_ORDERING )(x)
	x = Dropout(dropout_rate,name="block4_dropout")(x, training=True)
	f4 = x
	...
	x = ( BatchNormalization())(x)
	x = MaxPooling2D((2, 2), strides=(2, 2), name='block5_pool', data_format=IMAGE_ORDERING )(x)
	x = Dropout(dropout_rate,name="block5_dropout")(x, training=True)
	f5 = x
...
#Add grayscale image channel to bayes nn
def my_encoder(input_height=224 ,  input_width=224 , pretrained='imagenet',dropout_rate = 0):
	assert input_height%32 == 0
	assert input_width%32 == 0
	...
	#x = ( BatchNormalization())(x)
	x = MaxPooling2D((2, 2), strides=(2, 2), name='block2_pool', data_format=IMAGE_ORDERING )(x)
	#x = Dropout(dropout_rate,name="block2_dropout")(x, training=True)
	f2 = x
